...
make VERSION=%{version} rearguard_tarballs
...
* Fri Oct 12 2018 Patsy Griffin Franklin <pfrankli@redhat.com> - 2018-5
- Bump the Release and rebuild noarch.

* Mon Oct  8 2018 Patsy Franklin <pfrankli@redhat.com> - 2018e-4
...
- Update the tzdata.tar.gz file and make the tzdata.zi file during prep.
